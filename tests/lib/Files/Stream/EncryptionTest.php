...
class EncryptionTest extends \Test\TestCase {
	...
	protected function getStream($fileName, $mode, $unencryptedSize, $wrapper = '\OC\Files\Stream\Encryption') {
		...
		$util = $this->getMockBuilder('\OC\Encryption\Util')
			...
			->setConstructorArgs([new View(), new \OC\User\Manager($config, $this->createMock(EventDispatcherInterface::class), $this->createMock(IEventDispatcher::)), $groupManager, $config, $arrayCache])
			->getMock();
